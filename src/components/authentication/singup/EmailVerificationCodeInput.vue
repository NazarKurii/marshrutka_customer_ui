<template>
  <div class="flex gap-[4px] sm:gap-[20px]">
    <input
      ...
      class="size-[50px] sm:w-[60px] sm:h-[60px] bg-zinc-800 text-white rounded-lg text-2xl text-center shadow-md focus:outline-none focus:ring-2 focus:ring-amber-600"
      type="text"
      maxlength="5"
